...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-perfjankie/node_modules/perfjankie/lib/cli.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-perfjankie/node_modules/perfjankie/lib/cli.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-perfjankie/node_modules/perfjankie/lib/</a> &#187; cli.js</div>
</div>
<div class="body">
...
&nbsp;
var config = {};
<span class="missing-if-branch" title="if path not taken" >I</span>if (program.configFile) {
<span class="cstat-no" title="statement not covered" >	try {</span>
<span class="cstat-no" title="statement not covered" >		var config = JSON.parse(fs.readFileSync(program.configFile));</span>
	} catch (e) {
...
var extend = function(obj1, obj2) {
	for (var key in obj2) {
		<span class="missing-if-branch" title="if path not taken" >I</span>if (typeof obj1[key] !== 'undefined' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >typeof obj2[key] === 'object')</span> {
<span class="cstat-no" title="statement not covered" >			obj1[key] = extend(obj1[key], obj2[key]);</span>
...
&nbsp;
	couch: {
		...
		updateSite: program.onlyUpdateSite ? <span class="branch-0 cbranch-no" title="branch not covered" >true </span>: program.updateSite,
...
<span class="cstat-no" title="statement not covered" >		console.log(err, res);</span>
	}
});
&nbsp;
<span class="missing-if-branch" title="if path not taken" >I</span>if (program.migrate) {
<span class="cstat-no" title="statement not covered" >	console.log('Runnung database migrations');</span>
<span class="cstat-no" title="statement not covered" >	require('../migrations/index.js')(config, program.migrate).done();</span>
} else {
	require('./')(config);
}
&nbsp;</pre></td></tr>
